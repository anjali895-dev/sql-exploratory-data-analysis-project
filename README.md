...
/*Group customers into three segments based on their spending behavior:
 -VIP: Customers with a least 12 months of history and spending more than €5,000.
 -Regular: Customers with a least 12 months of history but spending €5,000 or less.
...
SELECT
	...
	SUM(sales_amount)AS total_sales,
	SUM(quantity)AS total_quantity,
	COUNT(DISTINCT product_key)AS total_product_key,
...
Highlights:
1. Gathers essential fields such as product name, category, subcategory, and c
